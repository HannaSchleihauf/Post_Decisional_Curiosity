...
xx.fe.re=fe.re.tab(fe.model="searched.after ~ age*condition*reward.received +
...
full <- glmer(searched.after ~ reward.received*condition*z.age + gender +
               (1 + (reward.received.low.code + reward.received.none.code) || id),
              data = t.data, control = contr,
              family = binomial(link = "logit"))

red <- glmer(searched.after ~ (reward.received+condition+z.age)^2 + gender +
              (1 + (reward.received.low.code + reward.received.none.code) || id),
             data = t.data, control = contr,
             family = binomial(link = "logit"))

red2 <- glmer(searched.after ~ reward.received + condition*z.age + gender +
               (1 + (reward.received.low.code + reward.received.none.code) || id),
              data = t.data, control = contr,
              family = binomial(link = "logit"))

main <- glmer(searched.after ~ reward.received + condition + z.age + gender +
               (1 + (reward.received.low.code + reward.received.none.code) || id),
              data = t.data, control = contr,
              family = binomial(link = "logit"))
...
ftable(searched.after ~ condition + reward.received, t.data)
ftable(searched.after ~ condition + age.group, t.data)
...
boot.full=boot.glmm.pred(model.res=full, excl.warnings=T,
                         nboots=1000, para=F, level=0.95, use=c("condition", "reward.received", "z.age"))
...
model.condition.age <- glmer(searched.after ~ condition*z.age + (reward.received.low.code + reward.received.none.code) +
                              (1 | id), data = t.data, control = contr,
                             family = binomial(link = "logit"))
boot.condition.age=boot.glmm.pred(model.res=model.condition.age, excl.warnings=T,
                                  nboots=1000, para=F, level=0.95, use=c("condition", "z.age"))
...
model.reward <- glmer(searched.after ~ reward.received + z.age*(condition.no.choice.code + condition.choice.code) +
                       (1 | id), data = t.data, control = contr,
                      family = binomial(link = "logit"))
